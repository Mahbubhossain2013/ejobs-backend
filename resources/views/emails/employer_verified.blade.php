...
<body style="font-family: 'Segoe UI', Arial, sans-serif; background-color: #f8fafc; margin: 0; padding: 40px 20px;">
    <div style="max-width: 480px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.06);">
        <div style="background: linear-gradient(135deg, #16a34a, #059669); padding: 32px 24px; text-align: center;">
            ...
            <p style="color: rgba(255,255,255,0.85); font-size: 13px; margin: 8px 0 0;">Account Verified!</p>
        </div>
        <div style="padding: 32px 24px;">
            <p style="font-size: 14px; color: #334155; line-height: 1.6; margin: 0 0 16px;">Hello <strong>{{ $employerName }}</strong>,</p>
            <p style="font-size: 14px; color: #334155; line-height: 1.6; margin: 0 0 24px;">
                Congratulations! Your company <strong>"{{ $companyName }}"</strong> has been verified by our team. You now have a verified badge and can access all employer features.
            </p>
            <div style="background: #f0fdf4; border-left: 4px solid #22c55e; border-radius: 8px; padding: 16px; margin: 0 0 24px;">
                <p style="font-size: 13px; color: #166534; margin: 0; font-weight: 600;">Verified benefits:</p>
                <p style="font-size: 13px; color: #166534; margin: 8px 0 0; line-height: 1.5;">
                    Verified badge on your profile, higher visibility in search results, and increased candidate trust.
                </p>
            </div>
            <a href="{{ $dashboardUrl }}" style="display: inline-block; background: #16a34a; color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: 600; font-size: 14px;">Go to Dashboard</a>
        </div>
